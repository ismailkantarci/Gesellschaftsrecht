# Bestands- und Lückenanalyse

Stand: 22.09.2026, nach begrenzter Methodenkernprüfung. Die Liste unterscheidet eingerichtete Arbeitsformen, dokumentierte Methodenprüfung und noch fehlende fachliche Ergebnisse.

| Bedarf | Vorhandener Anker | Tatsächlicher Stand | Nächste erforderliche Arbeit |
|---|---|---|---|
| Eigenständiger Auftrag | [ENT-0001](../05_entscheidungen/ent_0001_systemauftrag.md) | Vom Auftraggeber angenommene Richtung dokumentiert | Nur bei tatsächlicher Richtungsänderung neu entscheiden |
| Einheitliche Fachbegriffe | [Begriffe](../00_systemkern/begriffe_und_beziehungen.md) | Arbeitsdefinitionen angelegt | Am ersten echten Modell auf Widersprüche prüfen |
| Compliance-Ausgangsmaterial | [QU-0002](compliance_v08_bestandsaufnahme.md) | Original strukturell inventarisiert; keine erneute Rechtsprüfung | Sichere Ablage und gezielte Quellen-/Verweisprüfung |
| Bisherige Vertragspraxis | QU-0003 im [Quellenregister](quellenregister.md) | Noch nicht vollständig aufgenommen | Originale, Fassungen, Änderungen und Herkunft unterscheiden |
| Nutzen und Alternativen | [MA-0001](../04_modelle/ma_0001_arbeitsgesellschaftermodell.md) | Untersuchung vorbereitet | Tatsächlichen Bedarf und Alternativen belegen |
| Leistungen und Befugnisse | [Leistungen](../03_fachgebiete/leistungen_und_verguetung.md) | Fachlicher Prüfrahmen vorhanden | Tatsächlich übernommene Beiträge und notwendige Befugnisse vergleichen |
| Kosten und Betreuung | [Wirtschaftlichkeit](../03_fachgebiete/wirtschaftlichkeit_und_kapazitaet.md) | Keine echten Zahlen oder Zeitmessungen eingetragen | Reale Routine-/Ausnahmeaufwände und Entgeltbedingungen erheben |
| Kontrollfähigkeit | [Kontrollsysteme](../03_fachgebiete/kontrollsysteme_und_wirksamkeit.md) | Verfahren und Prüfbegriffe beschrieben | Durchführbarkeit, Befugnis und Nachweis an einem Modell prüfen |
| Anwendung in Gesellschaften | [Anwendung](../06_anwendung_und_pruefung/README.md) | Kein echter Gesellschaftsfall angelegt | Erst nach begrenztem Auftrag und Schutzprüfung |
| Wirkung | [Szenarioprüfungen](../06_anwendung_und_pruefung/szenariopruefungen.md) | Vier Methodenfälle durchgespielt und nachgeprüft; acht vorbereitet; keine Betriebsprüfung | Echte Anwendung und Wirkung mit geeigneten Originalen und Beobachtungen gesondert prüfen |

## Abgleich mit dem TAXIPartner-Bedarf

Auftrag vom 22.09.2026: den Kern auch am bekannten Geschäfts- und Organisationsbedarf prüfen. Grundlage sind der hier angenommene Systemauftrag, BP-0001 und der bereits dokumentierte Quellenbestand. Frühere Kenntnisse dienen nur als Suchhinweis, nicht als aktuelle Tatsachenbestätigung. Keine Regeln oder Entscheidungen anderer Repositorys wurden übernommen; keine vertraulichen Einzelfälle oder Geschäftszahlen veröffentlicht. Dieser Abgleich ist keine vollständige Bestandsprüfung aller TAXIPartner-Unternehmen.

| Bedarf | Bestehender fachlicher Ort | Abgleich / noch nicht belegtes Ergebnis |
|---|---|---|
| Nutzen für Fahrer, Betreiber und KMS; Alternativen statt bloßer Absicherung | [Wertschöpfung](../03_fachgebiete/geschaefts_und_wertschoepfungsmodelle.md), [Forschung](../02_forschung_und_entwicklung/README.md) | Beide Perspektiven sind vorgesehen; tatsächlicher Nutzen und Übertragbarkeit fremder Beispiele sind erst zu untersuchen. |
| Operative OG/KG, KMS-Arbeitsbeitrag und unterschiedliche Rollen | [BP-0001](../04_modelle/bp_0001_wien_ein_fahrzeug.md), [Kooperation](../03_fachgebiete/gesellschafts_und_kooperationsmodelle.md), [Führung](../03_fachgebiete/fuehrung_befugnisse_verantwortung.md) | Profilgrenze präzisiert: keine Beschäftigten gilt für die betrachtete OG/KG, nicht automatisch für KMS. Tatsächliche Rollen und Befugnisse bleiben quellenabhängig. |
| Leistung, Fixum, Zusatzaufwand, Rechnungsadressat, Schuldner und Zahler | [Leistung und Vergütung](../03_fachgebiete/leistungen_und_verguetung.md), [Verträge](../03_fachgebiete/vertraege_und_regelwerke.md) | Fachlich getrennt vorgesehen; keine gegenwärtigen Entgeltansprüche, Beträge oder bestehenden Vertragswirkungen neu festgestellt. |
| Bargeld, Kartenterminal, Plattformauszahlung, Rechnung und Überweisung | [BP-0001](../04_modelle/bp_0001_wien_ein_fahrzeug.md), [QU-0002](compliance_v08_bestandsaufnahme.md), [Compliance](../03_fachgebiete/recht_compliance_anwendbarkeit.md) | Unterschiedliche Zahlungs- und Belegketten bleiben getrennt. Plattformverträge, Steuereinordnung und Einzelfallabstimmung sind keine Ergebnisse dieser Kernprüfung. |
| Begrenzte Betreuungskapazität und gemeinsame Personen/Dienstleister | [Kapazität](../03_fachgebiete/wirtschaftlichkeit_und_kapazitaet.md), [Risiken](../03_fachgebiete/risikomanagement.md) | Routine, Ausnahmeaufwand, Reserve und gekoppelte Ausfälle sind vorgesehen. Echte Zeiten und Belastungsgrenzen wurden nicht gemessen. |
| Buchhaltungsübergaben, Behördenpost, fehlende Unterlagen und Nachfassen | [Betrieb](../03_fachgebiete/betriebsorganisation_und_dienstleister.md), [Prozess und Kontrolle](../08_vorlagen/prozess_und_kontrolle.md) | Ergebnis, Fristgrundlage und Störungsweg sind vorgesehen; ausgebliebene Kontrollen sind nun auch vor einem Istnachweis erfassbar. Keine laufende Überwachung eingerichtet. |
| Vertrauliche Originale, nachvollziehbare Fassungen und berechtigter Informationszugang | [Informationsordnung](../03_fachgebiete/daten_information_dokumente.md), [Quellen](quellenregister.md) | Maßgebliche Originale bleiben vom Arbeitsstand getrennt; vollständige Aufnahme der Vertragspraxis bleibt offen. |
| Änderung, Ausfall, Ruhen, Krise und Beendigung | [Lebenszyklus](../07_aenderungen_und_verbesserung/README.md), [Änderungsbewertung](../08_vorlagen/aenderungsbewertung.md) | Fachliche Folgen sind aussage- und fassungsbezogen zu verfolgen. Konkrete Übergangsfristen und fortbestehende Bindungen wurden nicht rechtlich bewertet. |

Im geprüften Bedarfsausschnitt ist kein zusätzlicher Fachbereich begründet. Die nachgewiesenen Methodenlücken wurden in vorhandenen Unterlagen präzisiert. Ein vorhandener Themenanker ist aber weder ein ausgefüllter Fachbestand noch ein Beleg, dass die tatsächliche Organisation bereits funktioniert.

## Reihenfolge

Zuerst Herkunft und Anwendungsrahmen klären. Dann in MA-0001 tatsächliche Leistung, Befugnis, Verantwortung, Aufwand und Kontrolle zusammenführen. Erst daraus gezielte Klauseländerungen oder ein Modellpaket entwickeln. Kein pauschaler Vertragsneubau vor der Bestandsprüfung.
